...
template<typename T>
using ordered_multiset_rev = tree<T, null_type, greater_equal<T>, rb_tree_tag, tree_order_statistics_node_update>;
...
template<typename T>
void __p(ordered_set_rev<T> a);
template<typename T>
void __p(ordered_multiset_rev<T> a);
template<typename T>
...
// dont ever add 1e18 to a long long gives precision error